...
## Requirements
1. [epoint-woocommerce-9.x.x.zip](http://r2.abbaszade.dev/epoint-opencart-v3.0.x-main.zip)
...
## Installation
1. Download "[epoint-woocommerce-9.x.x.zip](http://r2.abbaszade.dev/epoint-opencart-v3.0.x-main.zip)" ZIP File
2. In the WP-Admin open "Plugins" - "Add New"
3. Press "Upload Plugin" on the header
4. Upload "[epoint-woocommerce-9.x.x.zip](http://r2.abbaszade.dev/epoint-opencart-v3.0.x-main.zip)" ZIP file to Wordpress
